...
PYBIND11_MODULE(_nx_cpp, m) {
  ...
  graph_cls
      .def(py::init<int, const std::vector<std::pair<int, int>> &, bool>(), py::arg("num_nodes"), py::arg("edges"),
  ...
  m.def("pagerank", &pagerank, py::arg("graph"), py::arg("alpha") = 0.85, py::arg("max_iter") = 100,
        py::arg("tol") = 1e-6, "Minimal unweighted PageRank implementation.");
}
